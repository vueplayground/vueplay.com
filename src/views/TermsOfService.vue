		...
		<template #header="">
			...
			>
				...
				>
					...
					>The rules of the road —<br />what to expect when using our platform</Title>
					<h2>
						Updated 17.08.2023
					</h2>
					<section
					...
					>
						<h2>General Terms</h2>
						<p>By accessing or placing an order with Vue Play, you confirm that you are in agreement with and bound by the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and Vue Play.</p>
						<p>Under no circumstances shall Vue Play team be liable for any direct, indirect, special, incidental or consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the inability to use, the materials on this site, even if Vue Play team or an authorized representative has been advised of the possibility of such damages. If your use of materials from this site results in the need for servicing, repair or correction of equipment or data, you assume any costs thereof.</p>
						<p>Vue Play will not be responsible for any outcome that may occur during the course of usage of our resources. We reserve the rights to change prices and revise the resources usage policy in any moment.</p>
						<h2>License</h2>
						<p>Vue Play grants you a revocable, non-exclusive, non-transferable, limited license to download, install and use the website strictly in accordance with the terms of this Agreement.</p>
						<p>These Terms & Conditions are a contract between you and Vue Play (referred to in these Terms & Conditions as "Vue Play", "us", "we" or "our"), the provider of the Vue Play website and the services accessible from the Vue Play website (which are collectively referred to in these Terms & Conditions as the "Vue Play Service").</p>
						<p>You are agreeing to be bound by these Terms & Conditions. If you do not agree to these Terms & Conditions, please do not use the Vue Play Service. In these Terms & Conditions, "you" refers both to you as an individual and to the entity you represent. If you violate any of these Terms & Conditions, we reserve the right to cancel your account or block access to your account without notice.</p>
						...
						<ul>
							...
							<li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Siglar Development AS, Krabberodveien 47, 3960 stathelle that is responsible for your information under this Terms & Conditions.</li>
							<li>Country: where Vue Play or the owners/founders of Vue Play are based, in this case is NO</li>
							<li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Vue Play and use the services.</li>
							<li>Service: refers to the service provided by Vue Play as described in the relative terms (if available) and on this platform.</li>
							...
							<li>Website: Vue Play's site, which can be accessed via this URL: Vue Play.com</li>
							<li>You: a person or entity that is registered with Vue Play to use the Services.</li>
						</ul>
						<h2>Restrictions</h2>
						...
						<ul>
							...
							<li>Remove, alter or obscure any proprietary notice (including any notice of copyright or trademark) of Vue Play or its affiliates, partners, suppliers or the licensors of the website.</li>
						</ul>
						<h2>Return and Refund Policy</h2>
						<p>Thanks for shopping at Vue Play. We appreciate the fact that you like to buy the stuff we build. We also want to make sure you have a rewarding experience while you’re exploring, evaluating, and purchasing our products.</p>
						<p>As with any shopping experience, there are terms and conditions that apply to transactions at Vue Play. We’ll be as brief as our attorneys will allow. The main thing to remember is that by placing an order or making a purchase at Vue Play, you agree to the terms along with Vue Play's Privacy Policy.</p>
						...
						<p>Any feedback, comments, ideas, improvements or suggestions (collectively, "Suggestions") provided by you to Vue Play with respect to the website shall remain the sole and exclusive property of Vue Play.</p>
						<p>Vue Play shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose and in any way without any credit or any compensation to you.</p>
						<h2>Your Consent</h2>
						...
						<p>Vue Play reserves the right to modify, suspend or discontinue, temporarily or permanently, the website
							or any service to which it connects, with or without notice and without liability to you.</p>
						<h2>Updates to Our website</h2>
						<p>Vue Play may from time to time provide enhancements or improvements to the features/ functionality of the website, which may include patches, bug fixes, updates, upgrades and other modifications ("Updates").</p>
						<p>Updates may modify or delete certain features and/or functionalities of the website. You agree that Vue Play has no obligation to (i) provide any Updates, or (ii) continue to provide or enable any particular features and/or functionalities of the website to you.</p>
						...
						<p>This Agreement shall remain in effect until terminated by you or Vue Play.</p>
						<p>Vue Play may, in its sole discretion, at any time and for any or no reason, suspend or terminate this Agreement with or without prior notice.</p>
						<p>This Agreement will terminate immediately, without prior notice from Vue Play, in the event that you fail to comply with any provision of this Agreement. You may also terminate this Agreement by deleting the website and all copies thereof from your computer.</p>
						...
						<p>Termination of this Agreement will not limit any of Vue Play's rights or remedies at law or in equity in case of breach by you (during the term of this Agreement) of any of your obligations under the present Agreement.</p>
						...
						<p>You agree to indemnify and hold Vue Play and its parents, subsidiaries, affiliates, officers, employees, agents, partners and licensors (if any) harmless from any claim or demand, including reasonable attorneys' fees, due to or arising out of your: (a) use of the website; (b) violation of this Agreement or any law or regulation; or (c) violation of any right of a third party.</p>
						<h2>No Warranties</h2>
						...
						<p>Notwithstanding any damages that you might incur, the entire liability of Vue Play and any of its suppliers under any provision of this Agreement and your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by you for the website.</p>
						<p>To the maximum extent permitted by applicable law, in no event shall Vue Play or its suppliers be liable for any special, incidental, indirect, or consequential damages whatsoever (including, but not limited to, damages for loss of profits, for loss of data or other information, for business interruption, for personal injury, for loss of privacy arising out of or in any way related to the use of or inability to use the website, third-party software and/or third-party hardware used with the website, or otherwise in connection with any provision of this Agreement), even if Vue Play or any supplier has been advised of the possibility of such damages and even if the remedy fails of its essential purpose.</p>
						...
						<p>Vue Play reserves the right, at its sole discretion, to modify or replace this Agreement at any time. If a revision is material we will provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.</p>
						<p>By continuing to access or use our website after any revisions become effective, you agree to be bound by the revised terms. If you do not agree to the new terms, you are no longer authorized to use Vue Play.</p>
						<h2>Entire Agreement</h2>
						<p>The Agreement constitutes the entire agreement between you and Vue Play regarding your use of the website and supersedes all prior and contemporaneous written or oral agreements between you and Vue Play.</p>
						<p>You may be subject to additional terms and conditions that apply when you use or purchase other Vue Play's services, which Vue Play will provide to you at the time of such use or purchase.</p>
...
<script>
	...
	export default {
		...
		head() {
			return {
				title: 'Vue Play - Terms of Service',
				meta: [
				{
					name: 'description',
					content: 'Read the Vue Play Terms of Service to understand the rules and guidelines for using our platform.'
				},
				{
					property: 'og:title',
					content: 'Vue Play - Terms of Service'
				},
				{
				...
				{
					property: 'og:url',
					content: 'https://vueplay.com/terms-of-service'
				},
				{
					property: 'og:image',
				...
				{
					rel: 'canonical',
					href: 'https://vueplay.com/terms-of-service'
				}
				]
			}
			}
