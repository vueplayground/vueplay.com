			...
			>
				...
				>
					...
					>
						...
						<div style="margin-bottom:20px">Get full control over all text content within your components. You can edit the main text inside any element and easily manage text that appears before or after it. Vue Play also supports dynamic bindings, allowing you to insert reactive expressions or data-driven values directly into your content. This makes designing interactive and data-rich interfaces simple and entirely visual.</div><img
...
<script>
	...
	export default {
		...
		head() {
			...
			const url = 'https://vueplay.com/features/control/content'
			const title = 'Control - Content | Vue Play'
			const description = 'Get full control over your component content. Vue Play supports reactive expressions, text editing, and dynamic bindings for creating rich, interactive UIs visually.'
