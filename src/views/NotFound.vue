			...
			>
				...
				>
					<Box
						...
						color="{`default`:{`xs`:{`light`:`#151d2eff`,`dark`:`#f5f6faff`}}}"
					>
						<Title
						...
						>We could not find what you were looking for.</Title>
					</Box>
					<Box
						style="justify-content:center;"
						color="{`default`:{`xs`:{`light`:`#151d2eff`,`dark`:`#f5f6faff`}}}"
...
<script>
	import NotFound from '@/_templates/arctic/views/NotFound.vue';
