				...
				>
					...
					>
						<Text
							...
							class="hash"
						>Control - Attributes</Text>
					</Box> <Text>
						<div style="margin-bottom:20px">Vue Play gives you direct access to element attributes through a clean and intuitive attributes panel. You can add, edit, or remove any HTML or custom attributes — such as id, type, href, disabled without writing markup. This allows for fine-grained control over how elements behave, all while keeping the editing experience visual and efficient.</div><img
							src="@/assets/attrs.png"
...
<script>
	...
	export default {
		...
		head() {
			...
			const url = 'https://vueplay.com/features/control/attributes'
			const title = 'Control - Attributes | Vue Play'
			const description = 'Vue Play gives you direct access to element attributes through an intuitive panel. Add, edit, or remove HTML or custom attributes visually without writing markup.'
