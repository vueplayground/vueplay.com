				...
				>
					...
					>
						<Text
							...
							class="hash"
						>Transform - Rotation</Text>
					</Box> <Text>
						<div style="margin-bottom:20px">Vue Play includes a built-in rotate tool that makes turning elements effortless. Directly within the canvas, you can click and drag to rotate any component to the desired angle, enabling more creative freedom and visual expression.</div><img
...
<script>
	...
	export default {
		...
		head() {
			...
			return {
				title: 'Vue Play - Transform Rotation',
				meta: [
					{
						name: 'description',
						content: 'Rotate elements effortlessly in Vue Play. Use intuitive drag-to-rotate controls directly in the canvas to create expressive and creative layouts.'
					},
					{
						property: 'og:title',
						content: 'Vue Play - Transform Rotation'
					},
					{
						property: 'og:description',
						content: 'Use Vue Play’s built-in rotate tool to spin components with ease. Perfect for dynamic visuals and creative positioning.'
					},
					{
						property: 'og:type',
						content: 'website'
					...
					{
						property: 'og:url',
						content: 'https://vueplay.com/features/transform/rotation'
					},
					{
						property: 'og:image',
						content: image
				...
				link: [
					{
						rel: 'canonical',
						href: 'https://vueplay.com/features/transform/rotation'
					}
				]
			};
		}
