		...
		<template #header="">
			...
			>
				...
				>
					...
					>Your data, your trust —<br />here’s how we protect both</Title>
					<h2>
						Updated 17.08.2023
					</h2>
					<section
						style="margin:auto"
						class="max-w-xl container"
					>
						<p>
							Vue Play (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains
							how your personal information is collected, used, and disclosed by Vue Play.
						</p>
						<p>
							This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”)
							alongside our application, Vue Play.
						...
						<ul>
							...
							<li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Siglar Development
								AS, Krabberodveien 47, 3960 stathelle that is responsible for your information under this Privacy
								Policy.</li>
							<li>Country: where Vue Play or the owners/founders of Vue Play are based, in this case is
								Norway</li>
							<li>Customer: refers to the company, organization or person that signs up to use the Vue Play
							...
							<li>Device: any internet connected device such as a phone, tablet, computer or any other device that can
								be used to visit Vue Play and use the services.</li>
							...
							<li>Personnel: refers to those individuals who are employed by Vue Play or are under contract to
							...
							<li>Personal Data: any information that directly, indirectly, or in connection with other information —
								...
								natural person.</li>
							<li>Service: refers to the service provided by Vue Play as described in the relative terms (if
						...
						<h2>When does Vue Play use end user information from third parties?</h2>
						<p>Vue Play will collect End User Data necessary to provide the Vue Play services to our
							customers.</p>
						...
						<h2>When does Vue Play use customer information from third parties?</h2>
						<p>We receive some information from the third parties when you contact us. For example, when you submit your
							email address to us to show interest in becoming a Vue Play customer, we receive information from
							a third party that provides automated fraud detection services to Vue Play. We also occasionally
						...
						<p>Vue Play will collect personal information that you submit to us. We may also receive personal
							information about you from third parties as described above.</p>
						...
						<p>We keep your information only so long as we need it to provide Vue Play to you and fulfill the
							purposes described in this policy. This is also the case for anyone that we share your information with
							and who carries out services on our behalf. When we no longer need to use your information and there is
							no need for us to keep it to comply with our legal or regulatory obligations, we’ll either remove it
							from our systems or depersonalize it so that we can't identify you.</p>
						...
						<p>We implement a variety of security measures to maintain the safety of your personal information when you
							...
							any information you transmit to Vue Play or guarantee that your information on the Service may not
							be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or
							managerial safeguards.</p>
						<h2>Could my information be transferred to other countries?</h2>
						<p>Vue Play is incorporated in Norway. Information collected via our website, through direct
						...
						<h2>Is the information collected through the Vue Play Service secure?</h2>
						...
						<p>The rights you have to request updates or corrections to the information Vue Play collects depend
							on your relationship with Vue Play. Personnel may update or correct their information as detailed
							in our internal company employment policies.</p>
						...
						<h2>Personnel</h2>
						<p>If you are a Vue Play worker or applicant, we collect information you voluntarily provide to us. We
							use the information collected for Human Resources purposes in order to administer benefits to workers
						...
						<p>We reserve the right to transfer information to a third party in the event of a sale, merger or other
							transfer of all or substantially all of the assets of Vue Play or any of its Corporate Affiliates
							(as defined herein), or that portion of Vue Play or any of its Corporate Affiliates to which the
							Service relates, or in the event that we discontinue our business or file a petition or have filed
							against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party
						...
						<p>We may disclose information (including personal information) about you to our Corporate Affiliates. For
							...
							indirectly controls, is controlled by or is under common control with Vue Play, whether by
							ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will
							be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
						<h2>Governing Law</h2>
						<p>This Privacy Policy is governed by the laws of Norway without regard to its conflict of laws provision.
						...
						<p>The laws of Norway, excluding its conflicts of law rules, shall govern this Agreement and your use of the
							website. Your use of the website may also be subject to other local, state, national, or international
							laws.</p>
						<p>By using Vue Play or contacting us directly, you signify your acceptance of this Privacy Policy. If
						...
						<p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not
							operated or controlled by Vue Play. We are not responsible for the content, accuracy or opinions
						...
						<h2>Cookies</h2>
						<p>Vue Play uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a
							...
							to enter your login details every time you visit the website as we would not be able to remember that
							you had logged in previously. Most web browsers can be set to disable the use of Cookies. However, if
							you disable Cookies, you may not be able to access functionality on our website correctly or at all. We
						...
						<p>We use remarketing services. What Is Remarketing? In digital marketing, remarketing (or retargeting) is
							the practice of serving ads across the internet to people who have already visited your website. It
							allows your company to seem like they're “following” people around the internet by serving ads on the
							websites and platforms they use most.</p>
						...
						<p>We may display, include or make available third-party content (including data, information, applications
							...
							Services").</p>
						<p>You acknowledge and agree that Vue Play shall not be responsible for any Third-Party Services,
							including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency,
							quality or any other aspect thereof. Vue Play does not assume and shall not have any liability or
						...
						<ul>
							<li>Cookies <br /> <br />
								<p>We use Cookies to enhance the performance and functionality of our $platform but are
									...
									the $platform as we would not be able to remember that you had logged in previously.</p>
							</li>
							<li>Local Storage <br /> <br />
								<p>Local Storage sometimes known as DOM storage, provides web apps with methods and protocols for
									storing client-side data. Web storage supports persistent data storage, similar to cookies but
									with a greatly enhanced capacity and no information stored in the HTTP request header.</p>
							</li> <br />
							<li>Sessions <br /> <br />
								<p>Vue Play uses "Sessions" to identify the areas of our website that you have visited. A
						...
						<ul>
							...
							<li>Personal data should only be collected to fulfil a specific purpose and it should only be used for
								that purpose. Organizations must specify why they need the personal data when they collect it.</li>
						...
						<p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that
							...
							imposing greater fines for breach. Beyond these facts it's simply the right thing to do. At Vue
							Play we strongly believe that your data privacy is very important and we already have solid
							security and privacy practices in place that go beyond the requirements of this new regulation.</p>
						<h2>Individual Data Subject's Rights - Data Access, Portability and Deletion</h2>
						<p>We are committed to helping our customers meet the data subject rights requirements of GDPR. Vue
							Play processes or stores all personal data in fully vetted, DPA compliant vendors. We do store all
						...
						<p>We are aware that if you are working with EU customers, you need to be able to provide them with the
							...
							customer support team is here for you to answer any questions you might have about working with the API.
						</p>
...
<script>
	...
	export default {
		...
		head() {
			return {
				title: 'Vue Play - Privacy Policy',
				meta: [
				{
					name: 'description',
					content: 'Read Vue Play’s Privacy Policy to understand how we collect, use, and protect your personal information.'
				},
				{
					property: 'og:title',
					content: 'Vue Play - Privacy Policy'
				},
				{
				...
				{
					property: 'og:url',
					content: 'https://vueplay.com/privacy-policy'
				},
				{
					property: 'og:image',
				...
				{
					rel: 'canonical',
					href: 'https://vueplay.com/privacy-policy'
				}
				]
			}
			}
